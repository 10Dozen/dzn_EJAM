dzn_EJAM_fnc_ShowAdvDialog = {
/*
	[@Item1, @Item2, ... ,@ItemN] call dzn_EJAM_fnc_ShowAdvDialog;	
	...
	] call dzn_EJAM_fnc_ShowAdvDialog
...

{
	...
	private _lineProperties = [_line, _type, _data, _textParams, _tileParams, _expression, _widthMultiplier, [_args, ["STRING"]] call dzn_EJAM_fnc_stringify];
 ...
 */
with uiNamespace do { 
	createDialog "dzn_EJAM_Dynamic_Dialog_Advanced";
...
dzn_EJAM_fnc_stringify = {
/*
 *	@Result = [@Data, @StrongTypes] call dzn_EJAM_fnc_stringify;
 *	
 *	0: @Data (any)
